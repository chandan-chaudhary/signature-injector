...
export function PDFEditor() {
  ...
  const handleContainerResize = useCallback((dimensions: { width: number; height: number }) => {
        ...
        <main className="flex-1 p-4 lg:p-6 overflow-auto">
          {!pdfFile ? (
            <div className="flex flex-col items-center justify-center h-96 border-2 border-dashed border-border rounded-lg bg-muted/30">
              ...
              <p className="text-lg font-medium text-foreground mb-2">Upload a PDF to get started</p>
